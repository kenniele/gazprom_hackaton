...
названия из списка {course_names}. Обведите название подходящего курса в квадратные скобки: к примеру, [Разработка на 
Python].
""")]
...
На четвертом этапе разговора напиши только имя подходящего курса в квадратных скобках, не пиши ничего более.
