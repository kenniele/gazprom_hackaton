...
пишите ничего более. Подбирая курс, обращайте внимание на опыт и навыки пользователя. Если он их не указал - отдавай 
приоритет курсам с более низкими требованиями по навыкам. Строго соблюдай этот алгоритм, от этого зависит судьба 
вселенной."""
...
НИКОГДА НЕ ПИШИТЕ ИНФОРМАЦИЮ ОБ ЭТАПЕ РАЗГОВОРА, ИНАЧЕ УМРУТ КОТИКИ.
